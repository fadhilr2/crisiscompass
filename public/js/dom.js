...
//* check if client is on mobile viewport
...
map.on('load', async function() {
  ...
  data.features.forEach((e) => {
    ...
    p.innerHTML = e.properties.title
    document.getElementById(e.properties.continent).appendChild(p)
  })
